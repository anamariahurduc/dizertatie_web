...
<!--                    <div>-->
<!--                        <span class="block text-muted-color font-medium mb-4">Complaints resolved</span>-->
...
<!--                    </div>-->
<!--                </div>-->
<!--&lt;!&ndash;                <span class="text-primary font-medium">24 new </span>&ndash;&gt;-->
<!--&lt;!&ndash;                <span class="text-muted-color">since last visit</span>&ndash;&gt;-->
<!--            </div>-->
<!--        </div>-->
<!--        <div class="col-span-12 lg:col-span-6 xl:col-span-3">-->
<!--            <div class="card mb-0">-->
<!--                <div class="flex justify-between mb-4">-->
<!--                    <div>-->
<!--                        <span class="block text-muted-color font-medium mb-4">Complaints new</span>-->
...
<!--                    </div>-->
<!--                </div>-->
<!--&lt;!&ndash;                <span class="text-primary font-medium">%52+ </span>&ndash;&gt;-->
<!--&lt;!&ndash;                <span class="text-muted-color">since last week</span>&ndash;&gt;-->
<!--            </div>-->
<!--        </div>-->
<!--        <div class="col-span-12 lg:col-span-6 xl:col-span-3">-->
<!--            <div class="card mb-0">-->
...
<!--        </div>-->
        ...
        <div class="col-span-12 xl:col-span-6">
            <div class="card">
                <div class="font-semibold text-xl mb-4">Recent Complaints</div>
